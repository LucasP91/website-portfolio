...
**Whenever you build, generate, restyle, or substantially review UI** — any page, screen, component, form, section, or styled markup/CSS — follow these three steps in order. Apply this consistently; it is the default process for visual work, not an opt-in.
